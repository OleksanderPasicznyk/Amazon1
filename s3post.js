...
Policy.prototype.generateSignature = function(secretAccessKey){
	return helpers.hmac("sha1", secretAccessKey, this.generateEncodedPolicyDocument(), 'base64');	//generujemy signature z danych zawartych w config.json
}
...
var S3Form = function(policy){	
	...
	if(policy instanceof Policy)
		...
		console.log("policy instance of Policy");
		throw new Error("policy instance of Policy");
	}
	
}

S3Form.prototype.generateS3FormFields = function() { //generujemy(uzupelniamy)  fields w pliku index.ejs
